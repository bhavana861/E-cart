  ...
  return (
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
      ...
      <ul className='flex-1 text-right'>
       { insideHome && <li className='list-none inline-block px-5 font-bold'><input className='text-black' style={{width:'300px'}} type="text" placeholder='Search products here!!!' onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))} /></li>}
